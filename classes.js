...
const james = new Employee('James', 'Baker', 'egg@yum.com', 26)
console.log(james.makeWidget())
...
const timmy = new Manager ('Timmy', 'Freaple', 'manage@wow.com', 44)
console.log(timmy)
timmy.hire('julio')
timmy.hire('me')
timmy.hire('yolo')
...
const dummy = new ProgressiveManager
